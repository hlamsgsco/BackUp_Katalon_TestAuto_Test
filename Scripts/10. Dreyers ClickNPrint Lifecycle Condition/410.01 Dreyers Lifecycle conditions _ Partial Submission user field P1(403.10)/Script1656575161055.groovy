...
String password_bharandi = data_Dreyers.getValue(2, 4) //R
...
def project_name = (('TC410.01_Auto_LifecycleCondition_' + org.apache.commons.lang.RandomStringUtils.randomAlphanumeric(3)) + '_') + 
...
'Login as Marketing: Margaret Baughman > mbaughman'
...
'Verify that lifecycle status is Artwork Upload'
...
'Verify the lifecycle of granddaughter ref is Complete'
